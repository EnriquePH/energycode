...
The confusion matrix allows for the visualization of a classification
algorithm's performance.
In this blog post, a function is provided to create an image of the confusion
matrix.
The R package `caret` includes the `confusionMatrix` function, which generates a
