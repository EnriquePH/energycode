...
date: "2025-12-13"
lang: es
bibliography: 13122025-repunits.bib
nocite: |
  @*
categories:
  - Math
...
Un *repunit*[^1] es un número cuyos dígitos son todos igual a $1$ en una base determinada de un sistema de numeración posicional.
...
$2$.
En este post se estudia las propiedades de las series formadas por las sumas infinitas de los inversos de los *repunits*:

$$
S^{(b)} = \sum_{n=1}^{\infty}{\frac{1}{R_n^{(b)}}}
$${#eq-rep002}

Y también el comportamiento de las sumas parciales de sus recíprocos:
...
En el caso particular cuando $b=2$ se obtiene la constante de _Erdős–Borwein_
[@OEIS_A065442], definida como la suma de los inversos de los _números de
Mersenne_. Esta constante $E$ recibe su nombre en honor al matemático Paul
Erdős, quien demostró que es un _número irracional_ [@erdos1948_lambert], y también a *Peter Borwein*, quien extendió la demostración a otras series similares.
...
El artículo de _Peter B. Borwein_[@BORWEIN1991253] se demuestra que la serie:
$$
...
integrales de contorno, extendiendo resultados de _Erdős_ y
relacionando el problema con generalizaciones de la función divisor.
...
que se pueden considerar aproximaciones a las constantes $S^{(b)}$:
...
[^1]: En español se usa la denominación en inglés _repunit_, aunque también se usa el término _repituno_
